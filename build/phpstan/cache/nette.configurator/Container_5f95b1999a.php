...
class Container_5f95b1999a extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5f95b1999a $container)
			{
	...
	public function createServiceContainer(): Container_5f95b1999a
	{
		return $this;
	}
