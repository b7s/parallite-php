...
class Container_a868d5aeb7 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a868d5aeb7 $container)
			{
	...
	public function createServiceContainer(): Container_a868d5aeb7
	{
		return $this;
	}
