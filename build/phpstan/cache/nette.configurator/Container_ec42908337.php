<?php
// source: phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon
// source: /mnt/develop/underpixels/parallite/parallite-php/phpstan.neon
// source: array
...
class Container_ec42908337 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Rules\BooleansInConditions\BooleanRuleHelper' => [['0720']],
		'PHPStan\Rules\Operators\OperatorRuleHelper' => [['0721']],
		'PHPStan\Rules\VariableVariables\VariablePropertyFetchRule' => [['0722']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule' => [['0723']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule' => [['0724']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule' => [['0725']],
		'PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule' => [['0726']],
		'PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule' => [['0727']],
		'PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule' => [['0728']],
		'PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule' => [['0729']],
		'PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule' => [['0730']],
		'PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule' => [['0731']],
		'PHPStan\Rules\Cast\UselessCastRule' => [['0732']],
		'PHPStan\Rules\Classes\RequireParentConstructCallRule' => [['0733']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule' => [['0734']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule' => [['0735']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule' => [['0736']],
		'PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule' => [['0737']],
		'PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule' => [['0738']],
		'PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule' => [['0739']],
		'PHPStan\Rules\Functions\ArrayFilterStrictRule' => [['0740']],
		'PHPStan\Rules\Functions\ClosureUsesThisRule' => [['0741']],
		'PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule' => [['0742']],
		'PHPStan\Rules\Methods\IllegalConstructorMethodCallRule' => [['0743']],
		'PHPStan\Rules\Methods\IllegalConstructorStaticCallRule' => [['0744']],
		'PHPStan\Rules\Operators\OperandInArithmeticIncrementOrDecrementRule' => [['0745', '0746', '0747', '0748']],
		'PHPStan\Rules\Operators\OperandInArithmeticPostDecrementRule' => [['0745']],
		'PHPStan\Rules\Operators\OperandInArithmeticPostIncrementRule' => [['0746']],
		'PHPStan\Rules\Operators\OperandInArithmeticPreDecrementRule' => [['0747']],
		'PHPStan\Rules\Operators\OperandInArithmeticPreIncrementRule' => [['0748']],
		'PHPStan\Rules\Operators\OperandInArithmeticUnaryMinusRule' => [['0749']],
		'PHPStan\Rules\Operators\OperandInArithmeticUnaryPlusRule' => [['0750']],
		'PHPStan\Rules\Operators\OperandsInArithmeticAdditionRule' => [['0751']],
		'PHPStan\Rules\Operators\OperandsInArithmeticDivisionRule' => [['0752']],
		'PHPStan\Rules\Operators\OperandsInArithmeticExponentiationRule' => [['0753']],
		'PHPStan\Rules\Operators\OperandsInArithmeticModuloRule' => [['0754']],
		'PHPStan\Rules\Operators\OperandsInArithmeticMultiplicationRule' => [['0755']],
		'PHPStan\Rules\Operators\OperandsInArithmeticSubtractionRule' => [['0756']],
		'PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsRule' => [['0757']],
		'PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsCallableRule' => [['0758']],
		'PHPStan\Rules\StrictCalls\StrictFunctionCallsRule' => [['0759']],
		'PHPStan\Rules\SwitchConditions\MatchingTypeInSwitchCaseConditionRule' => [['0760']],
		'PHPStan\Rules\VariableVariables\VariableMethodCallRule' => [['0761']],
		'PHPStan\Rules\VariableVariables\VariableMethodCallableRule' => [['0762']],
		'PHPStan\Rules\VariableVariables\VariableStaticMethodCallRule' => [['0763']],
		'PHPStan\Rules\VariableVariables\VariableStaticMethodCallableRule' => [['0764']],
		'PHPStan\Rules\VariableVariables\VariableStaticPropertyFetchRule' => [['0765']],
		'PHPStan\Rules\VariableVariables\VariableVariablesRule' => [['0766']],
	];
	...
	{
		return new PHPStan\File\FileHelper('/mnt/develop/underpixels/parallite/parallite-php');
	}
	...
	public function createService016(): PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory
	{
		return new PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory(
			...
			[],
			$this->getParameter('analysedPaths'),
			['/mnt/develop/underpixels/parallite/parallite-php'],
			$this->getParameter('analysedPathsFromConfig'),
			false,
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/mnt/develop/underpixels/parallite/parallite-php/build/phpstan/resultCache.php');
	}
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/mnt/develop/underpixels/parallite/parallite-php'],
			[
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/mnt/develop/underpixels/parallite/parallite-php/phpstan.neon',
				'/mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan-strict-rules/rules.neon',
			],
			null,
			[
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute85.php',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
			],
			null,
			'9'
		);
	...
	public function createService081(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			$this->getService('05'),
			[
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/file.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/stream_socket_client.stub',
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/stubs/stream_socket_server.stub',
			],
			['/mnt/develop/underpixels/parallite/parallite-php']
		);
	}
	...
	{
		return new PHPStan\Rules\Methods\MethodCallCheck($this->getService('reflectionProvider'), $this->getService('0108'), true, true);
	}
	...
	public function createService0342(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/mnt/develop/underpixels/parallite/parallite-php',
			'/mnt/develop/underpixels/parallite/parallite-php/build/phpstan',
			[
				'phar:///mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'/mnt/develop/underpixels/parallite/parallite-php/phpstan.neon',
			],
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/mnt/develop/underpixels/parallite/parallite-php']);
	}
	...
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/mnt/develop/underpixels/parallite/parallite-php']);
	}
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ec42908337 $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/mnt/develop/underpixels/parallite/parallite-php/build/phpstan/resultCache.php',
	...
	{
		return new PHPStan\Rules\Properties\OverridingPropertyRule($this->getService('0355'), true, true);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/mnt/develop/underpixels/parallite/parallite-php');
	}
	...
	{
		return new PHPStan\Rules\Methods\MethodSignatureRule($this->getService('0116'), true, true);
	}
	...
	public function createService0720(): PHPStan\Rules\BooleansInConditions\BooleanRuleHelper
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanRuleHelper($this->getService('0108'));
	}


	public function createService0721(): PHPStan\Rules\Operators\OperatorRuleHelper
	{
		return new PHPStan\Rules\Operators\OperatorRuleHelper($this->getService('0108'));
	}


	public function createService0722(): PHPStan\Rules\VariableVariables\VariablePropertyFetchRule
	{
		return new PHPStan\Rules\VariableVariables\VariablePropertyFetchRule($this->getService('reflectionProvider'), ['stdClass']);
	}


	public function createService0723(): PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedLooseComparisonRule;
	}


	public function createService0724(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanAndRule($this->getService('0720'));
	}


	public function createService0725(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanNotRule($this->getService('0720'));
	}


	public function createService0726(): PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInBooleanOrRule($this->getService('0720'));
	}


	public function createService0727(): PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInDoWhileConditionRule($this->getService('0720'));
	}


	public function createService0728(): PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInElseIfConditionRule($this->getService('0720'));
	}


	public function createService0729(): PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInIfConditionRule($this->getService('0720'));
	}


	public function createService0730(): PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInTernaryOperatorRule($this->getService('0720'));
	}


	public function createService0731(): PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule
	{
		return new PHPStan\Rules\BooleansInConditions\BooleanInWhileConditionRule($this->getService('0720'));
	}


	public function createService0732(): PHPStan\Rules\Cast\UselessCastRule
	{
		return new PHPStan\Rules\Cast\UselessCastRule(true, true);
	}


	public function createService0733(): PHPStan\Rules\Classes\RequireParentConstructCallRule
	{
		return new PHPStan\Rules\Classes\RequireParentConstructCallRule;
	}


	public function createService0734(): PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedBacktickRule;
	}


	public function createService0735(): PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedEmptyRule;
	}


	public function createService0736(): PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedImplicitArrayCreationRule;
	}


	public function createService0737(): PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule
	{
		return new PHPStan\Rules\DisallowedConstructs\DisallowedShortTernaryRule;
	}


	public function createService0738(): PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule
	{
		return new PHPStan\Rules\ForeachLoop\OverwriteVariablesWithForeachRule;
	}


	public function createService0739(): PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule
	{
		return new PHPStan\Rules\ForLoop\OverwriteVariablesWithForLoopInitRule;
	}


	public function createService0740(): PHPStan\Rules\Functions\ArrayFilterStrictRule
	{
		return new PHPStan\Rules\Functions\ArrayFilterStrictRule($this->getService('reflectionProvider'), true, true, true);
	}


	public function createService0741(): PHPStan\Rules\Functions\ClosureUsesThisRule
	{
		return new PHPStan\Rules\Functions\ClosureUsesThisRule;
	}


	public function createService0742(): PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule
	{
		return new PHPStan\Rules\Methods\WrongCaseOfInheritedMethodRule;
	}


	public function createService0743(): PHPStan\Rules\Methods\IllegalConstructorMethodCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorMethodCallRule;
	}


	public function createService0744(): PHPStan\Rules\Methods\IllegalConstructorStaticCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorStaticCallRule;
	}


	public function createService0745(): PHPStan\Rules\Operators\OperandInArithmeticPostDecrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPostDecrementRule($this->getService('0721'));
	}


	public function createService0746(): PHPStan\Rules\Operators\OperandInArithmeticPostIncrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPostIncrementRule($this->getService('0721'));
	}


	public function createService0747(): PHPStan\Rules\Operators\OperandInArithmeticPreDecrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPreDecrementRule($this->getService('0721'));
	}


	public function createService0748(): PHPStan\Rules\Operators\OperandInArithmeticPreIncrementRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticPreIncrementRule($this->getService('0721'));
	}


	public function createService0749(): PHPStan\Rules\Operators\OperandInArithmeticUnaryMinusRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticUnaryMinusRule($this->getService('0721'));
	}


	public function createService0750(): PHPStan\Rules\Operators\OperandInArithmeticUnaryPlusRule
	{
		return new PHPStan\Rules\Operators\OperandInArithmeticUnaryPlusRule($this->getService('0721'));
	}


	public function createService0751(): PHPStan\Rules\Operators\OperandsInArithmeticAdditionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticAdditionRule($this->getService('0721'));
	}


	public function createService0752(): PHPStan\Rules\Operators\OperandsInArithmeticDivisionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticDivisionRule($this->getService('0721'));
	}


	public function createService0753(): PHPStan\Rules\Operators\OperandsInArithmeticExponentiationRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticExponentiationRule($this->getService('0721'));
	}


	public function createService0754(): PHPStan\Rules\Operators\OperandsInArithmeticModuloRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticModuloRule($this->getService('0721'));
	}


	public function createService0755(): PHPStan\Rules\Operators\OperandsInArithmeticMultiplicationRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticMultiplicationRule($this->getService('0721'));
	}


	public function createService0756(): PHPStan\Rules\Operators\OperandsInArithmeticSubtractionRule
	{
		return new PHPStan\Rules\Operators\OperandsInArithmeticSubtractionRule($this->getService('0721'));
	}


	public function createService0757(): PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsRule
	{
		return new PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsRule($this->getService('0108'));
	}


	public function createService0758(): PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsCallableRule
	{
		return new PHPStan\Rules\StrictCalls\DynamicCallOnStaticMethodsCallableRule($this->getService('0108'));
	}


	public function createService0759(): PHPStan\Rules\StrictCalls\StrictFunctionCallsRule
	{
		return new PHPStan\Rules\StrictCalls\StrictFunctionCallsRule($this->getService('reflectionProvider'));
	}


	public function createService0760(): PHPStan\Rules\SwitchConditions\MatchingTypeInSwitchCaseConditionRule
	{
		return new PHPStan\Rules\SwitchConditions\MatchingTypeInSwitchCaseConditionRule($this->getService('050'));
	}


	public function createService0761(): PHPStan\Rules\VariableVariables\VariableMethodCallRule
	{
		return new PHPStan\Rules\VariableVariables\VariableMethodCallRule;
	}


	public function createService0762(): PHPStan\Rules\VariableVariables\VariableMethodCallableRule
	{
		return new PHPStan\Rules\VariableVariables\VariableMethodCallableRule;
	}


	public function createService0763(): PHPStan\Rules\VariableVariables\VariableStaticMethodCallRule
	{
		return new PHPStan\Rules\VariableVariables\VariableStaticMethodCallRule;
	}


	public function createService0764(): PHPStan\Rules\VariableVariables\VariableStaticMethodCallableRule
	{
		return new PHPStan\Rules\VariableVariables\VariableStaticMethodCallableRule;
	}


	public function createService0765(): PHPStan\Rules\VariableVariables\VariableStaticPropertyFetchRule
	{
		return new PHPStan\Rules\VariableVariables\VariableStaticPropertyFetchRule;
	}


	public function createService0766(): PHPStan\Rules\VariableVariables\VariableVariablesRule
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/mnt/develop/underpixels/parallite/parallite-php/build/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_ec42908337
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/mnt/develop/underpixels/parallite/parallite-php');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/mnt/develop/underpixels/parallite/parallite-php');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 9,
			'paths' => ['/mnt/develop/underpixels/parallite/parallite-php/src'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/mnt/develop/underpixels/parallite/parallite-php/build/phpstan/resultCache.php',
			...
			'tmpDir' => '/mnt/develop/underpixels/parallite/parallite-php/build/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/mnt/develop/underpixels/parallite/parallite-php/build/phpstan',
			'rootDir' => '/mnt/develop/underpixels/parallite/parallite-php/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/mnt/develop/underpixels/parallite/parallite-php',
			...
			'composerAutoloaderProjectPaths' => ['/mnt/develop/underpixels/parallite/parallite-php'],
			...
			'env' => [
				...
				'SHLVL' => '1',
				'HOME' => '/home/bruno',
				'OLDPWD' => '/mnt/develop/underpixels/parallite/parallite-php',
				'CHROME_DESKTOP' => 'windsurf.desktop',
				'LESS' => '-R',
				'DESKTOP_SESSION' => 'ubuntu',
				'NVM_BIN' => '/home/bruno/.nvm/versions/node/v20.19.0/bin',
				'TERM_PROGRAM_VERSION' => '1.100.3',
				'GIO_LAUNCHED_DESKTOP_FILE' => '/usr/share/applications/windsurf.desktop',
				'ZSH' => '/home/bruno/.oh-my-zsh',
				'LSCOLORS' => 'Gxfxcxdxbxegedabagacad',
				'NVM_INC' => '/home/bruno/.nvm/versions/node/v20.19.0/include/node',
				'GTK_MODULES' => 'gail:atk-bridge',
				'GNOME_SHELL_SESSION_MODE' => 'ubuntu',
				'PAGER' => 'less',
				'VSCODE_GIT_ASKPASS_MAIN' => '/usr/share/windsurf/resources/app/extensions/git/dist/askpass-main.js',
				'LC_MONETARY' => 'pt_BR.UTF-8',
				'MANAGERPID' => '2642',
				'VSCODE_GIT_ASKPASS_NODE' => '/usr/share/windsurf/windsurf',
				'DBUS_SESSION_BUS_ADDRESS' => 'unix:path=/run/user/1000/bus',
				'GSM_SKIP_SSH_AGENT_WORKAROUND' => 'true',
				'SYSTEMD_EXEC_PID' => '2911',
				'P9K_TTY' => 'old',
				'GIO_LAUNCHED_DESKTOP_FILE_PID' => '191471',
				'COLORTERM' => 'truecolor',
				'COMPOSER_BINARY' => '/usr/local/bin/composer',
				'NVM_DIR' => '/home/bruno/.nvm',
				...
				'JOURNAL_STREAM' => '9:31767',
				'_P9K_SSH_TTY' => '/dev/pts/19',
				...
				'USER_ZDOTDIR' => '/home/bruno',
				'USERNAME' => 'bruno',
				'TERM' => 'xterm-256color',
				'GNOME_DESKTOP_SESSION_ID' => 'this-is-deprecated',
				'PATH' => '/mnt/develop/underpixels/parallite/parallite-php/vendor/bin:/home/bruno/.nvm/versions/node/v20.19.0/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin',
				'PAPERSIZE' => 'a4',
				'SESSION_MANAGER' => 'local/bruno-linx:@/tmp/.ICE-unix/2877,unix/bruno-linx:/tmp/.ICE-unix/2877',
				'INVOCATION_ID' => '09f65cac6d2141c3816cd5ba74497907',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/2s5j1vq926cvelhdZEX|1|*|*|/etc/php/8.4/cli/php.ini:/etc/php/8.4/cli/conf.d/10-mysqlnd.ini:/etc/php/8.4/cli/conf.d/10-opcache.ini:/etc/php/8.4/cli/conf.d/10-pdo.ini:/etc/php/8.4/cli/conf.d/15-xml.ini:/etc/php/8.4/cli/conf.d/20-bcmath.ini:/etc/php/8.4/cli/conf.d/20-bz2.ini:/etc/php/8.4/cli/conf.d/20-calendar.ini:/etc/php/8.4/cli/conf.d/20-ctype.ini:/etc/php/8.4/cli/conf.d/20-curl.ini:/etc/php/8.4/cli/conf.d/20-dom.ini:/etc/php/8.4/cli/conf.d/20-exif.ini:/etc/php/8.4/cli/conf.d/20-ffi.ini:/etc/php/8.4/cli/conf.d/20-fileinfo.ini:/etc/php/8.4/cli/conf.d/20-ftp.ini:/etc/php/8.4/cli/conf.d/20-gd.ini:/etc/php/8.4/cli/conf.d/20-gettext.ini:/etc/php/8.4/cli/conf.d/20-iconv.ini:/etc/php/8.4/cli/conf.d/20-igbinary.ini:/etc/php/8.4/cli/conf.d/20-imagick.ini:/etc/php/8.4/cli/conf.d/20-intl.ini:/etc/php/8.4/cli/conf.d/20-mbstring.ini:/etc/php/8.4/cli/conf.d/20-msgpack.ini:/etc/php/8.4/cli/conf.d/20-mysqli.ini:/etc/php/8.4/cli/conf.d/20-pdo_mysql.ini:/etc/php/8.4/cli/conf.d/20-pdo_sqlite.ini:/etc/php/8.4/cli/conf.d/20-phar.ini:/etc/php/8.4/cli/conf.d/20-posix.ini:/etc/php/8.4/cli/conf.d/20-readline.ini:/etc/php/8.4/cli/conf.d/20-shmop.ini:/etc/php/8.4/cli/conf.d/20-simplexml.ini:/etc/php/8.4/cli/conf.d/20-soap.ini:/etc/php/8.4/cli/conf.d/20-sockets.ini:/etc/php/8.4/cli/conf.d/20-sqlite3.ini:/etc/php/8.4/cli/conf.d/20-sysvmsg.ini:/etc/php/8.4/cli/conf.d/20-sysvsem.ini:/etc/php/8.4/cli/conf.d/20-sysvshm.ini:/etc/php/8.4/cli/conf.d/20-tokenizer.ini:/etc/php/8.4/cli/conf.d/20-xdebug.ini:/etc/php/8.4/cli/conf.d/20-xmlreader.ini:/etc/php/8.4/cli/conf.d/20-xmlwriter.ini:/etc/php/8.4/cli/conf.d/20-xsl.ini:/etc/php/8.4/cli/conf.d/20-zip.ini:/etc/php/8.4/cli/conf.d/25-memcached.ini:/etc/php/8.4/cli/conf.d/25-redis.ini|3.4.2',
				...
				'XMODIFIERS' => '@@im=ibus',
				'XAUTHORITY' => '/run/user/1000/.mutter-Xwaylandauth.A2P1D3',
				'SBX_CHROME_API_RQ' => '1',
				...
				'TERM_PROGRAM' => 'vscode',
				'VSCODE_GIT_IPC_HANDLE' => '/run/user/1000/vscode-git-74bf629509.sock',
				...
				'VSCODE_NONCE' => '69f824d8-1309-4593-a692-eac0141d0d1e',
				'PWD' => '/mnt/develop/underpixels/parallite/parallite-php',
				'XDG_DATA_DIRS' => '/home/bruno/.local/share/flatpak/exports/share:/var/lib/flatpak/exports/share:/usr/local/share/:/usr/share/:/var/lib/snapd/desktop',
				'NVM_CD_FLAGS' => '-q',
				'ZDOTDIR' => '/home/bruno',
				'_P9K_TTY' => '/dev/pts/19',
