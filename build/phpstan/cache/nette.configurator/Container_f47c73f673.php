...
class Container_f47c73f673 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f47c73f673 $container)
			{
	...
	public function createServiceContainer(): Container_f47c73f673
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'VSCODE_NONCE' => '0793562b-d5d2-4057-94ab-28746500e1ec',
