...
class Container_b67b6f7e6d extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_b67b6f7e6d $container)
			{
	...
	public function createServiceContainer(): Container_b67b6f7e6d
	{
		return $this;
	}
