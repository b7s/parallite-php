...
class Container_803afeed45 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_803afeed45 $container)
			{
	...
	public function createServiceContainer(): Container_803afeed45
	{
		return $this;
	}
